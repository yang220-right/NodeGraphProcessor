...
namespace GraphProcessor{
  ...
  public class BaseNodeView : NodeView{
    ...
    /// 存储节点的消息徽章
    /// </summary>
    [System.NonSerialized] List<IconBadge> badges = new List<IconBadge>();
    ...
    public void AlignToBottom(){
      ...
      foreach (var selectedNode in selectedNodes){
        selectedNode.SetPosition(
          GetNodeRect(selectedNode, top: selectedNodesFarBottom - selectedNode.localBound.size.y));
      }
    }
    ...
    protected VisualElement AddControlField(string fieldName, string label = null, bool showInputDrawer = false,
      ...
      => AddControlField(
        ...
        label, showInputDrawer, valueChangedCallback);
